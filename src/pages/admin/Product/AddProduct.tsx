...
export default function AddProduct() {
  ...
  const validateForm = (): boolean => {
    ...
    // 2. Shipping Dimensions validation (weightKg, lengthM, widthM, heightM + relationship length >= width >= height)
    ...
    if (productType === 'simple') {
      ...
      if (simpleStock === '' || isNaN(stock) || stock < 0) {
        newErrors.simpleStock = 'Số lượng tồn kho phải >= 0';
      }
    } else {
      // Variable product
            ...
            <div className="space-y-6">
              ...
              <div className="w-full">
                <TextField
                  ...
                  helperText={errors.productDescription || "Chi tiết chất liệu, xuất xứ và quy cách giặt là. Không quá 2000 ký tự."}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                <div className="md:col-span-2">
                  <TextField
                    ...
                    size="small"
                    helperText={errors.tagsInput || 'Tags phân cách bởi dấu phẩy, không chứa chữ số (ví dụ: Cotton, Summer)'}
                  />
                </div>
