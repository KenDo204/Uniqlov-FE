...
import { 
  ...
  DialogContent, DialogActions, Button, IconButton, Typography
} from '@mui/material';
import { 
  Search, Delete, Visibility, HelpOutlined, CheckCircle, ErrorOutlined
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center' }}>
            Bạn có chắc chắn muốn khóa/xóa sản phẩm này không? Hành động này sẽ chuyển trạng thái sản phẩm sang ngừng bán công khai.
          </Typography>
        </DialogContent>
