          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8 text-left">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="flex space-x-6 pt-2">
                <a href="#" className="text-gray-400 hover:text-theme-hover dark:hover:text-white transition-colors duration-300"><FaFacebook className="w-6 h-6" /></a>
                <a href="#" className="text-gray-400 hover:text-theme-hover dark:hover:text-white transition-colors duration-300"><FaInstagram className="w-6 h-6" /></a>
                <a href="#" className="text-gray-400 hover:text-theme-hover dark:hover:text-white transition-colors duration-300"><FaTwitter className="w-6 h-6" /></a>
                <a href="#" className="text-gray-400 hover:text-theme-hover dark:hover:text-white transition-colors duration-300"><FaYoutube className="w-6 h-6" /></a>
              </div>
            </div>
